    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 pt-24 pb-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-4 animate-fade-in-up">
            <span className="text-gradient-tropical">Fuel Your Day</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in-up stagger-3">
            <a href="sms:+14092097696">
              <Button size="lg" className="w-full sm:w-auto gap-2 btn-press animate-pulse-glow text-lg px-8 py-6 bg-primary hover:bg-primary/90">
                <MessageCircle className="h-5 w-5" />
                Text to Order
              </Button>
            </a>
            <a href="#menu">
              <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg px-8 py-6 btn-press border-primary/50 hover:bg-primary/10">
                See Menu
              </Button>
            </a>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-foreground/30 rounded-full flex items-start justify-center p-2">
          <div className="w-1 h-2 bg-foreground/50 rounded-full animate-fade-in" />
        </div>
      </div>
    </section>
  );
